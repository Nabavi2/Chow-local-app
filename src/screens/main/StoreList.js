                                ...
                                message: (
                                  <>               
                                    ...
                                    <AppText
                                      ...
                                      Your Chow Local subscription for {res.data.territory.name} is currently inactive. Tap the button below to pay your {res.data.territory.subscription_type} subscription fee.
                                    </AppText>
                                    <Button
                                      type="accent-green"
