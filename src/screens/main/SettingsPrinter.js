...
export const SettingsPrinterScreen = ({navigation}) => {
  ...
  const selectedPrinterAddress = useSelector(
  ...
  return (
    <Screen hasList isLoading={isLoading}>
      <TouchableOpacity
                ...
                <TouchableOpacity
                  ...
                  onPress={() => {
                    ...
                    BluetoothManager.connect(item.address).then(
                      ...
                      e => {
                        setLoading(false);
                        Alert.alert(
                          'connection error devices error',
                          JSON.stringify(e),
                        );
                      },
                    );
                  ...
                  <View style={{width: 40, alignItems: 'center'}}>
                    <CheckBox
                      ...
                      checked={
                        selectedPrinterAddress == item.address ? true : false
                      }
        ...
        <View
          style={
            printAsText ? styles.viewTerminalEnabled : styles.viewTerminal
          }>
        ...
        <View
          style={
            isAutoEnabled ? styles.viewTerminalEnabled : styles.viewTerminal
          }>
          <View style={{flexDirection: 'column', flex: 10}}>
            <AppText
              style={
              ...
              Auto-print new orders{isAutoEnabled}
            </AppText>
          </View>
          <View>
            <Switch
        ...
        <View>
          <AppText style={styles.heading_manual}>
            Manually Enter Printer Address
          </AppText>
          <View>
            <Input
              titleType="text"
