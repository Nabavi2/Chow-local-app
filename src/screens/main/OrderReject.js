        ...
        message: (
          <>
            ...
            <AppText
              ...
              This order has been rejected and refunded. The customer has been
              notified.
            </AppText>
            <Button
              type="white"
    ...
    <Screen isLoading={isLoading}>
      <View style={styles.container}>
        ...
        <View style={GlobalStyles.formControl}>
          <Button type="bordered-dark" onClick={() => orderReject('closed')}>
            We are closed
          </Button>
          ...
          <Button
            ...
            type="bordered-dark"
            onClick={() => {
              NavigationService.navigate('OrderRejectReason', {
                order_id: order_id,
              });
            }}>
            Other reason
