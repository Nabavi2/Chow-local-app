...
export const RequestDeliveryAddressScreen = ({navigation}) => {
  ...
  const saveDelivery = useCallback(() => {    
    ...
    .then((res) => {
      NavigationService.navigate("RequestDeliveryCustomer", {delivery_request_Id: delivery_request_Id, pickup_address: pickup_address, dropoff_address: address})
    })
    .catch((err) =>
      dispatch(
        showNotification({
...
return (
  <Screen isLoading={isLoading} hasList  keyboardAware={true} >
    <View style={styles.container}>
     <AppText style={styles.description}>Please enter drop off location address</AppText>
